  ...
  return (
    <>
            ...
            <div className='main-wrapper'>
                ...
                <div className='content1'>ERODE ARTS AND SCIENCE COLLEGE, RANGAMPALAYAM ,ERODE ARTS AND SCIENCE COLLEGE, RANGAMPALAYAM
             <br/>Erode - NEAR RING ROAD JUNCTION
             30/09/2023 to 30/09/2023 |  08:00 AM to 04:00 PM
             <br/>ABOVE 10000 VACANCIES MORE THAN 200 EMPLOYERS FREE SKILL TRAINING REGISTRATION FREE COACHING CLASS
             </div>
             </div>
             ...
             <div className='content1'>Sales Executive | SHRI VENKATESWARA HI TECH MACHINERIES PVT LTD
             <br/>Erode - NEAR RING ROAD JUNCTION
